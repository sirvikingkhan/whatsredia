...
export default function HelpsManager() {
    ...
    const handleSubmit = async (data) => {
        ...
        try {
            ...
            toast.error('La operación no se pudo realizar.. Verifique se já existe uma helpo com o mesmo nome ou se os campos foram preenchidos corretamente')
        }
        setLoading(false)
    }
