    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          queueRedirectionDesc: "Seleccione una Area para os contatos que não possuem fila serem redirecionados",
          prompt: "Prompt",
      ...
      contacts: {
        ...
        confirmationModal: {
          ...
          deleteMessage:
            "Tem certeza que deseja deletar este contato? Todos os Servicios relacionados serão perdidos.",
      ...
      tickets: {
        toasts: {
          deleted: "O Servicio que você estava foi deletado.",
        },
        notification: {
          message: "Mensagem de",
        },
        ...
        search: {
          placeholder: "Buscar Servicio e mensagens",
        },
        buttons: {
          showAll: "Todos",
        },
      ...
      transferTicketModal: {
        ...
        fieldQueuePlaceholder: "Seleccione una Area",
        noOptions: "Ningun usuário encontrado com esse nome",
        buttons: {
          ok: "Transferir",
          cancel: "Cancelar",
        },
      ...
      ticketsList: {
        ...
        noTicketsMessage:
          "Ningun Servicio encontrado com esse status ou termo pesquisado",
        buttons: {
          accept: "Aceitar",
          closed: "Finalizar",
          reopen: "Reabrir"
      ...
      queueIntegration: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! e será removida das Areas e conexões vinculadas",
        },
      },
      files: {
      ...
      campaigns: {
        ...
        dialog: {
          ...
          form: {
            ...
            messagePlaceholder: "Contenido da mensagem",
            whatsapp: "Conexão",
            status: "Status",
            scheduledAt: "Agendamento",
            confirmation: "Confirmação",
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Você tem certeza? Essa ação não pode ser revertida! Os Servicios dessa fila continuarão existindo, mas não terão mais Ninguna fila atribuída.",
        },
      },
      queueSelect: {
        inputLabel: "Areas",
      ...
      users: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Todos os dados do usuário serão perdidos. Os Servicio abertos deste usuário serão movidos para a fila.",
        },
      },
      helps: {
      ...
      backendErrors: {
        ...
        ERR_NO_DEF_WAPP_FOUND:
          "Ningun WhatsApp padrão encontrado. Verifique a página de conexões.",
        ...
        ERR_NO_SETTING_FOUND: "Ninguna configuração encontrada com este ID.",
        ERR_NO_CONTACT_FOUND: "Ningun contato encontrado com este ID.",
        ERR_NO_TICKET_FOUND: "Ningun tíquete encontrado com este ID.",
        ERR_NO_USER_FOUND: "Ningun usuário encontrado com este ID.",
        ERR_NO_WAPP_FOUND: "Ningun WhatsApp encontrado com este ID.",
        ...
        ERR_WAPP_GREETING_REQUIRED:
          "A mensagem de saudação é Obligatorio quando há mais de uma fila.",
      },
    },
  },
};
